...
public class explicitWaitExample {
    public static void main(String[] args) {
        ...
        //Create an object for Explicit wait --> Give webdriver as an argument followed by duration
    ...
    public static void submitCart(WebDriver driver,WebDriverWait wait){
